...
// All URLs to the Advanced I/O function will be of the pattern: /server/{function_name}/{url_path}
    $.ajax({
        url: "/server/AlienCityAIO/alien", //Ensure that 'AlienCityAIO' is the package name of your function
        type: "post",
...
function getAlienEncounter() {
 ...
 // All URLs to the function will be of the pattern: /server/{function_name}/{url_path}
    $.ajax({
        url: "/server/AlienCityAIO/alien?city_name=" + city, //Ensure that 'AlienCityAIO' is the package name of your function
        type: "get",
        success: function (data) {
            console.log(data);
            $("#result-text").text("");
